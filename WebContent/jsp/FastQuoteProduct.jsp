...
<body
	...
	<div id="mainframe">
		...
		<div id="rightContainer">
			<div id="header_index">
				<div id="headerleft">
					<img src="../images/imageareabgImg.jpg"
			...
			<div style="font-size: 15px;" id="accordion">
				...
				<p>Fast Quote Product</p>
			</div>

			<p
				style="font-size: 16px; margin-left: 4.5%;padding-right:2%; margin-top: 3%; line-height: 25px">We
				provide protection for all types of insurance. Protect you and your
				family with the right insurance. Call us today for details.</p>
		</div>
